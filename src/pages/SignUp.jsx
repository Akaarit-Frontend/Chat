                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="vendor_form_heading">
                                    <h2 style={{color:'#f4732a'}}>Sign Up</h2>
                                    ...
                                    <div className="sign_form_box">
                                        <form action="!#" id="tour_bookking_form_item">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="form-group">
                                                        <input type="text" className="form-control bg_input" placeholder="Company Name"/>
                                                    </div>
                                                </div>
                                                <div className="col-lg-6">
                                                    <div className="form-group">
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="form-group">
                                                        <input type="password" className="form-control bg_input" placeholder="Confirm Password*"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <div className="col-lg-4">
                                <div className="vendor_img">
                                    <img src="./images/banner/register.png" alt="Login"/>
                                </div>
                            </div>
                        </div>
                    </div>
